...
FILE *fp;
char *nome_file = "matplot/dati/well_probability_453.csv";
...
{
	// Variabili:
	double k = sqrt(E_kin/alpha - 1/(width*width));
	...
	k = k_plane_ris_wave, width = min_width;
	...
	// // Print reciproc:
	// print_reciproc_packet(&pacchetto);
