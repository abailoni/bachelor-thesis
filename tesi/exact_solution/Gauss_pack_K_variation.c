...
#define delta_E_res 0.00560675 // gamma/2
// #define N 8192
...
int main(int argc, char const *argv[])
{
	...
	// double d_width = 0.025;
	double d_E = 0.0001;
	double E_start = 0.083411544;
	// double d_k = sqrt(d_E/alpha);
	// printf("d_k====%g %g\n", d_k, k_resonance);
	int N_k = 15;
	...
	for (int i = 0; i < N_k; ++i)
	{
		...
		sprintf(name_file_prob,"matplot/dati/prob_K/prob_%4.4g_%d.csv",random_num,i); 
		sprintf(name_file_anim,"matplot/dati/anim_K/anim_%4.4g_%d.csv",random_num,i); 
